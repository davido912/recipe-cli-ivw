Interview Problem
==== 
This is an interview problem I was given, I decided to keep them publicly on github for example purposes and because time was spent on those tasks - so why not.
